...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin Panel | Aplikasi Persediaan Barang dengan PHP7 dan MySQLi</title>
  ...
  <body class="skin-blue fixed">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="?module=home" class="logo">Inventory Livaza</a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2017 - <a href="https://livaza.com">www.livaza.com</a></strong>
      </footer>
    </div><!-- ./wrapper -->
