      ...
      <div class="col-lg-12 col-xs-12">
        <div class="alert alert-info alert-dismissable">
          ...
          <p style="font-size:15px">
            <i class="icon fa fa-user"></i> Selamat datang <strong><?php echo $_SESSION['nama_user']; ?></strong> di Aplikasi Inventory Barang Livaza.
          </p>        
        </div>
      </div>
    </div>
          ...
          <div class="box-body">
            <div class="table-responsive">
              ...
              <table class="table no-margin">
                ...
                $no = 1;
                // fungsi query untuk menampilkan data dari tabel barang
                $query = mysqli_query($mysqli, "SELECT a.id_barang,a.nama_barang,a.id_jenis,a.id_satuan,a.stok,b.id_jenis,b.nama_jenis
                                                FROM is_barang as a INNER JOIN is_jenis_barang as b
