...
if ($_GET['form']=='add') { 
  if (isset($_GET['id'])) {
    ...
    // $query = mysqli_query($mysqli, "SELECT id_barang,nama_barang,id_satuan,stok
    //                                 FROM is_barang
          ...
          <form role="form" class="form-horizontal" action="modules/barang-keluar/proses.php?act=insert" method="POST" name="formBarangKeluar">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input style="width: 35px" type="text" class="form-control" id="stok" name="stok" value="<?php echo $stok; ?>" readonly required>
                </div>
              </div>
              </span>
