      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT a.id_barang_keluar,a.tanggal_keluar,a.id_barang,a.jumlah_keluar,b.id_barang,b.nama_barang,b.id_satuan
                                            FROM is_barang_keluar as a INNER JOIN is_barang as b
                                            ON a.id_barang=b.id_barang ORDER BY id_barang_keluar DESC")
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <td width='120'>$data[jumlah_keluar]</td>
