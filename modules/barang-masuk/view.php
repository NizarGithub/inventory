      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT a.id_barang_masuk,a.tanggal_masuk,a.id_barang,a.jumlah_masuk,b.id_barang,b.nama_barang,b.id_satuan
                                            FROM is_barang_masuk as a INNER JOIN is_barang as b
                                            ON a.id_barang=b.id_barang ORDER BY id_barang_masuk DESC")
