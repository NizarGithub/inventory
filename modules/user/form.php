...
elseif ($_GET['form']=='edit') { 
    ...
    $select_admin=""; $select_manajer=""; $select_gudang="";
    switch ($data["hak_akses"]) {
        case 'Admin': $select_admin = "selected";
          # code...
          break;

          case 'Manajer': $select_manajer = "selected";
          # code...
          break;

          case 'Gudang': $select_gudang = "selected";
          # code...
          break;
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <select class="form-control" name="hak_akses" required>
                    ...
                    <option value="Manajer" <?php echo $select_manajer;?>>Manajer</option>
                    <option value="Gudang"<?php echo $select_gudang;?>>Gudang</option>
                  </select>
                </div>
              </div>
            </div><!-- /.box body -->
